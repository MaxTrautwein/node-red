...
RED.nodes = (function() {
    ...
    function convertNode(n, opts) {
        ...
        if (n._def.category != "config") {
            ...
            if (node.full_wires === undefined || node.full_wires.length != n.outputs) node.full_wires = [];
            for(var i=0;i<n.outputs;i++) {
                node.wires.push([]);
                if (node.full_wires.length != n.outputs){
        ...
        for (i=0;i<new_nodes.length;i++) {
            ...
            if (n.wires) {
                for (var w1=0;w1<n.wires.length;w1++) {
                    ...
                    let fwires = (n.full_wires[w1] instanceof Array)?n.full_wires[w1]:[n.full_wires[w1]];
                    for (var w2=0;w2<wires.length;w2++) {
                        if (node_map.hasOwnProperty(wires[w2])) {
                            if (n.z === node_map[wires[w2]].z) {
                               var targetport = fwires[w2].target_port || 0;
