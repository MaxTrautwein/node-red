...
RED.nodes = (function() {
    ...
    function convertNode(n, opts) {
        ...
        if (n._def.category != "config") {
            ...
            node.wires = [];
            //add full_wires property if needed
            ...
            for (var j=0;j<wires.length;j++) {
                ...
                if (w.target.type != "subflow") {
                    if (w.sourcePort < node.wires.length) {
                        ...
                        //Save target port information
                        node.full_wires[w.sourcePort].push({"target_port":w.target_port});
                    }
                }
            }
                    ...
                    if (node.type === "group") {
                        ...
                        if (!node._def) {
                            if (node.x && node.y) {
                                ...
                                delete node.y;
                                delete node.wires;
                                //TODO Check add delete node.full_wires;
                    ...
                    for (var w2=0;w2<wires.length;w2++) {
                        if (node_map.hasOwnProperty(wires[w2])) {
                            if (n.z === node_map[wires[w2]].z) {
                                //Add target port info to link object
