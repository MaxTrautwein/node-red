    ...
    function DebugNode(n) {
        ...
        this.on("input", function(msg, send, done) {
            ...
            if (this.complete === "true") {
                ...
                //Thast odd where did the msg.source.id go? i can see it node.js
                console.log("msg: " + msg[0] + " msg.source " + msg[0].source + "   " + msg[0].source.id);
                prepareValue(msg,function(err,debugMsg) {
                    if (err) {
                        node.error(err);
                        return;
                    ...
                    if (node.active) {
                        if (node.tosidebar == true) {
                           // console.log("Data: " + debugMsg.msg + " flow:  " + debugMsg.path + "  " + debugMsg.source.id );
                            sendDebug(debugMsg);
                        }
                    }
                    done();
