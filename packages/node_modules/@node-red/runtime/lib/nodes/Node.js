...
function Node(n) {
    ...
    if (n.full_wires != undefined && n.full_wires[0] != undefined){
        //We have deata for connected full_wires
        let nfull_wires = [];
        
        //Helper variable
        let tmp = n.full_wires[0];
       
        for (let i = 0;i<tmp.length;i++){
            nfull_wires.push(tmp[i]);
        }

        this.full_wires = nfull_wires;
    }else{
        this.full_wires = undefined;
    }
                ...
                for (var j = 0; j < wires.length; j++) {
                    ...
                    for (k = 0; k < msgs.length; k++) {
                        ...
                        if (m !== null && m !== undefined) {
                            ...
                            m["__port"] = this.full_wires[j]["target_port"];
                            sendEvents.push({
                                msg: m,
                                source: {
                                    id: this.id,
